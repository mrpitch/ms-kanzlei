...
export function Header() {
	...
	return (
		<div className="sticky top-0 z-50 bg-background backdrop-blur supports-backdrop-filter:bg-background/60 border-b border-border">
			<Container as="header">
				<div className="flex items-center justify-between h-16 md:h-20">
					...
					<Button variant="secondary" size="icon"
						type="button"
						className="lg:hidden p-2 ml-2 rounded-md transition-colors cursor-pointer"
